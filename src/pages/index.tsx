      ...
      <main className="flex justify-center min-h-screen py-20 bg-gradient-to-b from-gray-50 via-gray-50 to-gray-100">
        <div>
          ...
          <h2 className="max-w-4xl px-10 mx-auto mt-8 text-base tracking-tight text-center text-gray-600 sm:text-2xl md:mt-5 md:text-2xl">
            Tailwind CSS 2.0, Prettier and TypeScript without a single line of
            config! Easily extendable zero-config template for pros and
            beginners.
          </h2>

          <div className="px-4 sm:px-0">
            <section
              className="w-full mt-6 bg-white rounded-lg sm:mt-20 sm:grid-cols-2 sm:w-1000"
              style={{
                minHeight: "350px",
